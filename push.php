...
$thanksPage = "https://followerscount.site/thanks";
...
$require = array('yourName', 'email', 'number');
...
$refrom_name = "YKデザインスタジオ";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "今週の目標を確認しました。";
...
<p><?php echo confirmOutput($_POST);//入力内容を表示?></p>
</table>
...
送信ありがとうございました。<br />
送信は正常に完了しました。<br /><br />
<div class="btn--orange"><a href="<?php echo $site_top ;?>">トップページへ戻る&raquo;</a></div>
</div>
<!-- <?php copyright(); ?> -->
...
function copyright(){
	echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href=""  rel="noreferrer noopener" target="_blank">* Made in YKDesignStudio. *</a>';
}
//----------------------------------------------------------------------
//  関数定義(END)
//----------------------------------------------------------------------
